  ...
  return (
    <DashboardLayout role="user">
      <div className="space-y-6">
        {/* Header section (already handled by TopBar breadcrumbs usually, but adding inner page title) */}
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white p-4 rounded-lg border border-gray-50 shadow-sm">
            ...
            <p className="text-xl font-black text-dark">42</p>
          </div>
          <div className="bg-white p-4 rounded-lg border border-gray-50 shadow-sm">
            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">
              Selesai
            </p>
            <p className="text-xl font-black text-green-600">38</p>
          </div>
          <div className="bg-white p-4 rounded-lg border border-gray-50 shadow-sm">
            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">
              Total Berat
            </p>
            <p className="text-xl font-black text-dark">124.5kg</p>
          </div>
          <div className="bg-white p-4 rounded-lg border border-gray-50 shadow-sm">
            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">
              Point Didapat
            </p>
            <p className="text-xl font-black text-primary">2.4k</p>
          </div>
        </div>
                    ...
                    <div className="flex items-center justify-between pt-2">
                      <div className="flex items-center gap-2">
                        <div className="w-6 h-6 rounded-full bg-gray-100 overflow-hidden border border-white">
                          <img
                            src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${order.courier}`}
                            alt="Courier"
                          />
                        </div>
