...
export default function OrderDetailView({ id }: OrderDetailViewProps) {
  ...
  const order = {
    ...
    paymentMethod: "Angkutin Wallet",
    courier: {
      name: "Asep Sunandar",
      id: "AGT-99212",
      rating: 4.9,
      phone: "+62 812 3456 7890",
      photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=Asep",
    },
    timeline: [
      { status: "Pesanan Dibuat", time: "14:00", completed: true },
      { status: "Kurir Menuju Lokasi", time: "14:05", completed: true },
      { status: "Kurir Tiba di Lokasi", time: "14:10", completed: true },
      { status: "Sampah Ditimbang", time: "14:15", completed: true },
      { status: "Sampah Diangkut", time: "14:20", completed: true },
      { status: "Drop Point Daur Ulang", time: "14:25", completed: true },
      { status: "Pesanan Selesai", time: "14:30", completed: true },
    ],
    items: [
      { name: "Sampah Mutu", qty: "3.2 kg", price: "Rp 16.000" },
      { name: "Sampah Residu", qty: "2.0 kg", price: "Rp 9.000" },
    ],
  };
    ...
    <DashboardLayout role="user">
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-extrabold text-dark">Detail Pesanan</h2>
