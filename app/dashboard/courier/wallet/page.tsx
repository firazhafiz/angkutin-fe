                ...
                <>
                  ...
                  {!showAllTx && transactions.length > 5 && (
                    <button
                      ...
                      className="w-full mt-4 py-5 text-xs font-bold text-primary rounded-full border border-primary border-dashed transition-colors uppercase tracking-widest cursor-pointer"
                    >
