  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-16 pb-24">
        {/* Hero Section */}
        <div className="bg-linear-to-b from-primary/0 via-primary/10 to-primary/0 py-20 mb-16">
          <div className="container mx-auto px-6 max-w-7xl text-center">
            ...
            >
              Latest news, tips, and insights on sustainable waste management
            ...
            <div className="flex flex-col md:flex-row gap-4 max-w-3xl mx-auto">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 rounded-full border border-gray-300 focus:outline-none focus:ring-1 focus:ring-primary/20 focus:border-primary transition-all"
                  value={searchQuery}
