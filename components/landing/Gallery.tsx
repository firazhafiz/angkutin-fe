...
export default function GallerySection() {
  const galleryItems = [
    ...
    {
      image:
        "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?q=80&w=2070&auto=format&fit=crop",
  ...
  return (
    <section
      id="gallery"
      className="md:pt-16 pt-8 pb-16 bg-white overflow-hidden"
    >
      <div className="mx-auto  px-6 max-w-6xl">
        ...
        <div className="flex flex-col items-center text-left mb-16">
          ...
          <motion.p
            ...
            className="text-2xl md:text-3xl font-extralight text-dark tracking-tight uppercase"
          >
            Gallery
          </motion.p>
        </div>
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center opacity-0 group-hover:opacity-100 transition-all duration-700 transform translate-y-2 group-hover:translate-y-0">
                ...
                <div className="relative mb-4">
                  <Image
                    ...
                    width={100}
                    height={100}
                    className="object-contain w-30 h-auto brightness-0 invert"
                  />
                </div>

                <p className="text-white text-xs md:text-lg font-light leading-relaxed max-w-xs">
                  {item.text}
                </p>
              </div>
            </motion.div>
